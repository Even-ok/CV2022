 ...
 *
 */
package com.example.rostest.result.xml;

import android.text.TextUtils;
import android.util.Xml;

import com.example.rostest.result.FinalResult;
import com.example.rostest.result.ReadSentenceResult;
import com.example.rostest.result.ReadSyllableResult;
import com.example.rostest.result.ReadWordResult;
import com.example.rostest.result.Result;
import com.example.rostest.result.entity.Phone;
import com.example.rostest.result.entity.Sentence;
import com.example.rostest.result.entity.Syll;
import com.example.rostest.result.entity.Word;
